...
gfortran -fopenmp $GMXXTC/xtc-interface-wrap.o $OPENMMDCD/dcdmod.o $OPENMMDCD/trajmod.o variables.f90 topol.f90 fvector.f90 filehandle.f90 qq_structure_factor.f90 -o calc_qq_struct_omp -lxdrfile -L $GMXXTC/lib -I $GMXXTC -I $OPENMMDCD -ffree-line-length-256
